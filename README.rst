...
es2csv
======
To fetch data from AWS ElasticSearch Endpoint
---------------------------------------------------------------
...
.. code-block:: bash
    ...
    python2 es2csv_cli.py -u https://xxxxxxx.ap-northeast-1.es.amazonaws.com -i live_viewed_by_minute -o csv_live_viewed_by_minute.csv -r -q '{"query" : {"match_all" : {}}}'
